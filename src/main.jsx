...
const portfolio = [
  ...
  { cat: 'pm', gradient: 'card-gradient-3', decor: '🏪', category: 'Operations / Executive', title: 'BeePawn Multi-Location Ops Overhaul', link: 'https://www.notion.so/BeePawn-Operations-Hub-PM-Executive-Office-34eb3df263db8104acb2e7af82f9f48c?source=copy_link', metrics: [['30%', 'Faster Delivery'], ['98%', 'Inventory Accuracy']] },
  { cat: 'pm dev', gradient: 'card-gradient-4', decor: '🔗', category: 'Automation / Slack Integration', title: 'Slack Bot Workspace Integration', link: 'https://www.notion.so/Slack-Bot-Integration-Project-25bb3df263db8094ab93ef7d91ca529b?source=copy_link', metrics: [['35%', 'Efficiency Gain'], ['15hrs', 'Saved / Week']] },
  { cat: 'pm dev', gradient: 'card-gradient-1', decor: '🎧', category: 'Zendesk / AI Agent', title: 'Peter Sage Zendesk AI Agent Integration', link: 'https://www.notion.so/Peter-Sage-Zendesk-AI-Agent-Integration-25bb3df263db8190a76cd1b4ee283dc6?source=copy_link', metrics: [['AI', 'Agent Integration'], ['Zendesk', 'Workflow']] },
